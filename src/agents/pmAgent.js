...
FORMAT 1:
{
  ...
  "assumptions": ["Assumption I'm making"]
}
...
export async function pmAgentNode(state) {
  ...
  if (!result.ok) {
    ...
    return {
      ...
      tokenUsage: emptyTokenDelta("pmAgent"),
    };
  }
